...
form_sentnotedialogwindow = uic.loadUiType("sentnoteDialog.ui")[0]

class SentnoteDialog(QDialog, QWidget, form_sentnotedialogwindow):

    def __init__(self):
        super(SentnoteDialog, self).__init__()
        self.setupUi(self)
        self.initUI()
...
#        print(messagebox.getId())
        ...
        reply = QMessageBox.question(self, '알림', '보낸 편지함에서 쪽지를 삭제하시겠습니까?',
...
#            print(messagebox.getId())
            ...
            # 메시지 박스 삭제처리
            messengerService.updateSendRemoveMessage(messagebox)
